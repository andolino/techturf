<div class="cont-view-signatory w-100 row none">
		<div class="col-8">
   		<div class="row">
   			<div class="col-12">
   		...
   		<div class="row">
				<div class="col-4 pb-3">
					<button type="button" class="btn btn-sm font-12 btn-default rounded-0 border" id="loadSidePage" data-link="get-signatory-frm" data-title="ADD SIGNATORY" data-id=""><i class="fas fa-user-plus"></i> Add Signatory</button>
				</div>
			</div>
			<table class="table table-sm font-12" id="tbl-signatory-settings">
				<thead>
					<tr>
