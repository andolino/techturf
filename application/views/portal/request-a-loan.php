<div class="cont-add-member row w-100 m-auto">
	<div class="col-sm-12 req-ln-tbl">
		...
		<table class="table font-12 w-100" id="tbl-portal-loan-request-list">
			<thead>
				<tr>
	...
	<div class="col-sm-12 req-ln-frm none">
		<form id="frm-request-a-loan" enctype="multipart/form-data">
			<div class="row">
					<!-- heading -->
					<div class="col-sm-12 mb-3">
						<div class="navbar mb-0">
							<h6 class="mb-0"><i class="fas fa-user-cog"></i> Loan Request</h6>
						</div>
					</div>
					<!-- end -->
